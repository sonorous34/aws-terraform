...
```terraform
module "my-ecs" {
  source         = "github.com/aws-terraform/terraform-modules//modules/ecs-cluster"
  vpc_id         = "vpc-id"
  cluster_name   = "my-ecs"
...
```terraform
module "my-ecs" {
  source         = "github.com/aws-terraform/terraform-modules//modules/fargate-cluster"
  cluster_name   = "my-ecs"
  log_group      = "my-log-group"
}
```
...
```terraform
module "my-service" {
  source              = "github.com/aws-terraform/terraform-modules//modules/ecs-service"
  vpc_id              = "vpc-id"
...
```terraform
module "my-alb" {
  source             = "github.com/aws-terraform/terraform-modules/modules/alb"
  vpc_id             = "vpc-id"
  lb_name            = "my-alb"
  vpc_subnets        = "subnetId-1,subnetId-2"
...
```terraform
module "my-alb-rule" {
  source             = "github.com/aws-terraform/terraform-modules/modules/alb-rule"
...
module "alb" {
  source      = "git@github.com:aws-terraform/terraform-modules.git//modules/alb"
...
module "vpn" {
  source         = "git@github.com:aws-terraform/terraform-modules.git//modules/openvpn"
  env            = "dev"
  domain         = "example.com"
...
```terraform
module "wireguard" {
  source       = "github.com/aws-terraform/terraform-modules/modules/wireguard"
  env          = "prod"
...
```terraform
module "mysql" {
  source              = "git@github.com:aws-terraform/terraform-modules.git//modules/rds"
...
```
module "site2site" {
  source             = "github.com/aws-terraform/terraform-modules/modules/wireguard-site2site"
  env                = "prod"
