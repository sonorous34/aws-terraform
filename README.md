...
```terraform
module "my-ecs" {
  source         = "github.com/sonorous34/aws-terraform/modules/ecs-cluster"
  vpc_id         = "vpc-id"
  cluster_name   = "my-ecs"
...
```terraform
module "my-ecs" {
  source         = "github.com/sonorous34/aws-terraform/modules/fargate-cluster"
  cluster_name   = "my-ecs"
  log_group      = "my-log-group"
}
```
...
```terraform
module "my-service" {
  source              = "github.com/sonorous34/aws-terraform/modules/ecs-service"
  vpc_id              = "vpc-id"
...
```terraform
module "my-alb" {
  source             = "github.com/sonorous34/aws-terraform/modules/alb"
  vpc_id             = "vpc-id"
  lb_name            = "my-alb"
  vpc_subnets        = "subnetId-1,subnetId-2"
...
```terraform
module "my-alb-rule" {
  source             = "github.com/sonorous34/aws-terraform/modules/alb-rule"
...
module "vpn" {
  source         = "git@github.com:sonorous34/aws-terraform.git/modules/openvpn"
  env            = "dev"
  domain         = "example.com"
...
```terraform
module "wireguard" {
  source       = "github.com/sonorous34/aws-terraform/modules/wireguard"
  env          = "prod"
...
```
module "site2site" {
  source             = "github.com/sonorous34/aws-terraform/modules/wireguard-site2site"
  env                = "prod"
